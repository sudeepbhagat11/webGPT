...
var openai_config_1 = require("../config/openai_config");
var openai_1 = require("openai");
var openai = new openai_1.default();
var generateChatCompletion = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var message, user, chats, config, openai_2, chatResponse, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                message = req.body.message;
                return [4 /*yield*/, userModel_1.default.findById(res.locals.jwtData.id)];
            case 1:
                user = _a.sent();
                if (!user) {
                    return [2 /*return*/, res
                ...
                config = (0, openai_config_1.configureOpenAI)();
                openai_2 = new openai_1.default(config);
                return [4 /*yield*/, openai_2.chat.completions.create({
                        messages: chats,
                        model: "gpt-3.5-turbo",
                    })];
            case 2:
            ...
            case 4:
                error_1 = _a.sent();
                console.log(error_1);
                return [2 /*return*/, res.status(500).json({ message: "Something went error" })];
