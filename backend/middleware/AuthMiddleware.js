...
var protect = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                JWT_SEC = process.env.JWT_SECTRE || 'default-mongodb-uri';
                decoded = jsonwebtoken_1.default.verify(token, JWT_SEC);
                _a = req;
                return [4 /*yield*/, userModel_1.default.findById(decoded._userId).select('-password')];
            case 2:
                _a.user = _b.sent();
